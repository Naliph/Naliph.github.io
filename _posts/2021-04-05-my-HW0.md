---
layout: post
title: HW0 - Penguins Data Visualization
---
...
There is a correlation between these 2 measurements. Penguins with smaller Culmen Lengths and Body Masses are most likely Adelie penguins. While penguins with large Culmen Lengths and Masses are most likely Gentoo.<br>
...
<div class="gave-help">
Some gave help text, nothing yet since HW0 and no feedback yet
</div>
...
{::options parse_block_htmn="true /}
<div class="got-help">
Got Help text. HW0 and no feedback so this here just a colorful example block.
</div>
{::options parse_block_html="false" /}